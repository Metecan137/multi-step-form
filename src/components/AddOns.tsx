...
import { addOnsToList, ons, timeToggle } from "../features/multiformSlice/multiformSlice"
...
function AddOns() {
  ...
  useEffect(() => {
    dispatch(addOnsToList({ name: "Online Services", price: toggle ? 1 * 10 : 1 }))
    dispatch(addOnsToList({ name: "Large Storage", price: toggle ? 2 * 10 : 2 }))
    dispatch(addOnsToList({ name: "Customizable Profile", price: toggle ? 2 * 10 : 2 }))
  }, [toggle])
    ...
    <div className="flex flex-col md:pt-10 md:px-24 pt-6 px-6 h-120 lg:h-140">
      <div className="h-full">
        ...
        <label className="cursor-pointer">
          <div className={`flex justify-between ${getOns.some(item => item.name === "Online Services") ? "bg-neutral-blue-100" : ""} items-center gap-10 border hover:border-primary-blue-950 border-neutral-grey-500 w-full h-auto rounded-lg px-2 py-2 sm:px-4 sm:py-4 mt-8`}>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-neutral-grey-500 text-sm md:text-base">Acces to multiplayer games.</p>
              </div>
            </div>
        ...
        <label className="cursor-pointer">
          <div className={`flex justify-between ${getOns.some(item => item.name === "Large Storage") ? "bg-neutral-blue-100" : ""} items-center gap-10 border hover:border-primary-blue-950 border-neutral-grey-500 w-full h-auto rounded-lg px-2 py-2 sm:px-4 sm:py-4 mt-4`}>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-neutral-grey-500 text-sm md:text-base">Extra 1TB of cloud storage.</p>
              </div>
            </div>
        ...
        <label className="cursor-pointer">
          <div className={`flex justify-between ${getOns.some(item => item.name === "Customizable Profile") ? "bg-neutral-blue-100" : ""} items-center gap-10 border hover:border-primary-blue-950 border-neutral-grey-500 w-full h-auto rounded-lg px-2 py-2 sm:px-4 sm:py-4 mt-4`}>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-neutral-grey-500 text-sm md:text-base">Custom theme on your profile.</p>
              </div>
            </div>
            <div><p className="text-primary-blue-950 text-sm">{toggle ? "+$20/mo" : "+$2/mo"}</p></div>
          </div>
